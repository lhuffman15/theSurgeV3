...
function preload(){
	...
	section1 = loadImage('assets/instructionsNoText.png');
	section2 = loadImage('assets/challengeOneSetupNoText.png');
	section3 = loadImage('assets/challegeOneSuccessNoText.png');
	section4 = loadImage('assets/challengeOneFailNoText.png');
	section5 = loadImage('assets/challengeTwoSetupNoText.png');
	section6 = loadImage('assets/challengeTwoSuccessNoText.png');
	section7 = loadImage('assets/challengeTwoFailureNoText.png');
	section8 = loadImage('assets/finalBattleOneNoText.png');
...
if (sectionNum == 11) {
	...
	text("YOU WIN! Well done! Refresh the page to try again!", pad, h+pad, w - pad, 300);
}
